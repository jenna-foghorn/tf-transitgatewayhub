...
## Versioning
This module was originally forked from the community module [terraform-aws-transit-gateway v2.9.0](https://github.com/terraform-aws-modules/terraform-aws-transit-gateway/releases/tag/v2.9.0)

Its provided examples were re-written and replaced with implementations more closely aligned with internal design goals.
